...
I joined as a guest guitarist for **NAVER Onstage Episode 157** (2013) —
three songs were broadcast.

## NAVER Onstage 157 — *Connection*

{% include youtube.html id="56dv3XHUISY" title="온스테이지 157. 잠비나이 — Connection" quality="maxresdefault" %}

## NAVER Onstage 157 — *소멸의 시간 (The Time of Annihilation)*

{% include youtube.html id="egiR6rjrrWY" title="온스테이지 157. 잠비나이 — 소멸의 시간" quality="maxresdefault" %}

## NAVER Onstage 157 — *Grace Kelly*

{% include youtube.html id="IUtzgznmslY" title="온스테이지 157. 잠비나이 — Grace Kelly" quality="maxresdefault" %}

## Notes

This was a stylistically unusual collaboration — switching from metalcore
...
- [Jambinai (Wikipedia)](https://en.wikipedia.org/wiki/Jambinai)
- [NAVER Onstage archive](https://onstage.naver.com/)
